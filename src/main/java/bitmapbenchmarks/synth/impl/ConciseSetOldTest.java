...
public class ConciseSetOldTest extends AbstractBitsetTest {

    @Override
    public String getDescription() { return "# ConciseSetTestOld 32 bit using the extendedset_2.2 library"; }
